...
(doom! :input
       ...
       (corfu +orderless +icons +cape) ; complete with cap(f), cape and a flying feather!
       ...
       (org +roam +pretty +contacts +dragndrop +pandoc +present) ; organize your plain life in plain text
       ...
       ;;rhttps://github.com/jimeh/emacs-buildsst               ; ReST in peace
