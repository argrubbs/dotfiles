...
;; Buffer operations (C-c b prefix)
...
;; Window management (C-c w prefix)
...
;; Text editing and manipulation (C-c e prefix)
...
;; Search and replace (C-c s prefix)
...
;; Help and documentation (C-c h prefix)
