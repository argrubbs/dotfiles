...
;; File operations (C-c F prefix - capital F to avoid conflicts)
...
;; Buffer operations (C-c B prefix - capital B to avoid conflicts)
...
;; Window management (C-c W prefix - capital W to avoid conflicts)
...
;; Text editing and manipulation (C-c E prefix - capital E to avoid org export conflicts)
...
;; Search and replace (C-c S prefix - capital S to avoid org super-agenda conflicts)
...
;; Help and documentation (C-c H prefix - capital H to avoid conflict)
